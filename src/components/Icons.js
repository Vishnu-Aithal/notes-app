...
export const LogOutIcon = ({ className }) => {
    return (
        <svg
            ...
            stroke="currentColor"
            xmlns="http://www.w3.org/2000/svg">
            <line x1="1.5" y1="23" x2="1.5" strokeWidth="2.5" />
            <g className="group-hover:translate-x-1 transition-transform duration-200 z-10">
                <path
                    d="M7 11L16 11"
                    strokeWidth="2.5"
                    strokeLinecap="square"
                />
                <path d="M21 11L15 16.1962V5.80385L21 11Z" />
            </g>
        </svg>
    );
};
